<?php 
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'delete' && isset($_GET['id_comment'])) {
        $id_com = $_GET['id_comment'];

        if ($commentaire->Delete_comment($id_com)) {
            header("Location: comments.php?");
            exit();
        } else {
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                ...
                                                <a href="comments.php?action=delete&id_comment=<?php echo $row['id_commentaire'] ?>" 
