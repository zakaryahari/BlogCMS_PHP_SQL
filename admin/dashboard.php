<?php 
      ...
      $sql_Totalusers = "SELECT COUNT(*) FROM utilisateur";
      $sql_Totalarticle = "SELECT COUNT(*) FROM article";
      $sql_Totalviews = "SELECT SUM(view_count) FROM article";
      $sql_comment = "SELECT COUNT(*) FROM commentaire WHERE status = 'pending'";

      $stmt = $db->query($sql_Totalusers);
      $Totalusers = $stmt->fetchColumn();

      $stmt = $db->query($sql_Totalarticle);
      $Totalarticle = $stmt->fetchColumn();

      $stmt = $db->query($sql_Totalviews);
              ...
              <ul class="mt-6">
                  <li class="relative px-6 py-3">
                      ...
                      <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" 
                        href="/BRIEF-8/admin/dashboard.php">
              ...
              <ul>
                  <li class="relative px-6 py-3">
                      <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" 
                        href="/BRIEF-8/admin/categories.php">
                          <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li class="relative">
                ...
                <template x-if="isProfileMenuOpen">
                  <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" @click.away="closeProfileMenu" @keydown.escape="closeProfileMenu" class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700" aria-label="submenu">
                    ...
                    <li class="flex">
                      <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200" href="assets/php/logout.php">
                        <svg class="w-4 h-4 mr-3" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
              ...
              <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                  ...
                  <p class="text-lg font-semibold text-gray-700 dark:text-gray-200"><?php echo $Totalarticle ?></p>
                </div>
              </div>
              <!-- Card -->
              <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                  ...
                  <p class="text-lg font-semibold text-gray-700 dark:text-gray-200"><?php echo $Totalviews ?></p>
                </div>
              </div>
              <!-- Card -->
              <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                  <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pending Comments</p>
                  <p class="text-lg font-semibold text-gray-700 dark:text-gray-200"><?php echo $TotalPending ?></p>
                </div>
              </div>
            </div>
